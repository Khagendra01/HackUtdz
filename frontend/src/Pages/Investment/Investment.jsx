			...
			<main className="flex-1 overflow-auto">
				<div className="p-8">
					<h1 className="text-4xl mb-4">
						Learn <strong>Investments</strong>
					</h1>
					<p className="mb-6">
						Discover the world of investments and grow your wealth with
						confidence. From stocks and bonds to mutual funds and real estate,
						explore diverse opportunities to achieve your financial goals.
						Leverage insights, tools, and strategies tailored to your
						preferences to make informed, smarter investment decisions.
					</p>
					<hr className="mb-12" />
					{inputAtBottom && (
						<div
				...
				{!inputAtBottom && (
					<div className="w-full h-16 flex justify-center items-center space-x-4">
						...
						<button
							className="rounded-full bg-gray-100 px-4 py-2 border"
							onClick={() => handleButtonClick("What is an investment?")}
						>
